Sonaly Leather – E-commerce Website

Developed a fully functional and responsive e-commerce website for a leather brand, Sonaly Leather, focused on delivering a modern and seamless online shopping experience.
...
The website also features clean UI/UX design, responsive layout for mobile and desktop, and efficient state management using local storage to maintain cart data across sessions.

Tech Stack:
Frontend: HTML, CSS, JavaScript
Backend: Node.js, Express.js
Database: MongoDB
Other: LocalStorage, REST APIs, WhatsApp Integration
